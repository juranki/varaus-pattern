...
const svgs = Object.freeze({
    ...
    spinner: index.h("svg", { width: "24", height: "24", viewBox: "0 0 38 38", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor" },
        index.h("g", { fill: "none", "fill-rule": "evenodd" },
            index.h("g", { transform: "translate(1 1)", "stroke-width": "4" },
                index.h("circle", { "stroke-opacity": ".3", cx: "18", cy: "18", r: "16" }),
                index.h("path", { d: "M 34 18 c 0 -9.5 -6.5 -16 -16 -16" },
                    index.h("animateTransform", { attributeName: "transform", type: "rotate", from: "0 18 18", to: "360 18 18", dur: "1s", repeatCount: "indefinite" }))))),
});
