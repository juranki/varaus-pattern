...
const VarausButton = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("button", { type: this.type, onClick: this.action }, this.icon && Icons.getIcon(this.icon), index.h("div", null, index.h("slot", null)))));
    }
};
...
const VarausFormField = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "form-row" }, index.h("label", { htmlFor: this.name }, this.label), index.h("div", { class: "input-wrap" }, this.icon && Icons.getIcon(this.icon), index.h("input", { disabled: this.disabled, type: this.type, name: "email", value: this.value, placeholder: this.placeholder, onChange: evt => {
