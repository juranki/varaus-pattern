...
const VarausFormField = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "form-row" }, h("label", { htmlFor: this.name }, this.label), h("div", { class: "input-wrap" }, this.icon && getIcon(this.icon), h("input", { disabled: this.disabled, type: this.type, name: "email", value: this.value, placeholder: this.placeholder, onKeyUp: evt => {
