...
var VarausSignInForm = /** @class */ (function () {
    ...
    class_1.prototype.validateAll = function () {
        var _this = this;
        return Object.keys(this.fieldValidations).every(function (k) { return (_this.validateField(k)); });
    };
    // SUBMIT
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.action(this.email, this.password)];
                    case 1:
                        _a.sent();
                        this.loading = false;
                        return [2 /*return*/];
