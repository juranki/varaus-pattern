...
export class VarausSignInForm {
    ...
    render() {
        return (h("form", { onSubmit: e => this.submit(e), onKeyUp: e => e.key === 'Enter' && this.submit(e) },
            ...
            h("div", { class: "login-action-row" },
                h("varaus-button", { type: "submit", onClick: e => this.submit(e) }, "Kirjaudu"),
                h("p", null,
                    "Ei tunnusta? ",
                ...
                h("p", null,
                    h("button", { type: "button", class: "some-button fb", onClick: (e) => this.federatedAction(e, 'facebook') },
                    ...
                    h("button", { type: "button", class: "some-button google", onClick: (e) => this.federatedAction(e, 'google') },
    ...
    static get events() { return [{
            ...
            "complexType": {
                "original": "SignInAction",
                "resolved": "SignInAction",
                "references": {
                    "SignInAction": {
                        "location": "local"
                    }
